...
public class Proyecto implements Serializable
{
	 ...
	 * 
	 */
	public boolean crearProceso(Proceso nuevoProceso)
	{
	...
	public void modificarProceso(String idBusqueda,String id, String nombre) throws ObjetoRepetidoExcepcion, DatoNoEncontradoException
	{
		...
		if(encontrado!= null)
		{
			if(buscarProcesoBoolean(id)!=true)
			{
				...
				encontrado.setListaDeActividades(buscarProceso(idBusqueda).getListaDeActividades());
	 ...
	 * 
	 */
	public boolean crearActividadNormal(String idProceso,Actividad nuevaActividad) throws ObjetoRepetidoExcepcion, DatoNoEncontradoException
	{
		...
		if(encontrado!=null)
		{
			agregado=encontrado.agregarActividadNormal(nuevaActividad);
			return agregado;
		}
		else
		{
	 ...
	 * 
	 */
	public boolean crearActividadEnPosicion(String idProceso, String nombre, Actividad actividadNueva) throws DatoNoEncontradoException, ObjetoRepetidoExcepcion 
	{	
		Proceso encontrado= buscarProceso(idProceso);
		boolean agregado;
		...
		if(encontrado!=null)
		{
			agregado=encontrado.agregarActividadEnPosicion(nombre, actividadNueva);
			return agregado;
		}
		else
		{
	 ...
	 * 
	 */
	public boolean crearActividadAlUltimo(String idProceso,Actividad nuevaActividad) throws ObjetoRepetidoExcepcion, DatoNoEncontradoException
	{
		Proceso encontrado= buscarProceso(idProceso);
		boolean agregado;
		...
		if(encontrado!=null)
		{
			agregado=encontrado.agregarActividadAlUltimo(nuevaActividad);
			return agregado;
		}
		else
		{
	 ...
	 * 
	 */
	public boolean crearActividadDespuesDeLaUltimaCreada(String idProceso, Actividad actividadNueva) throws ObjetoRepetidoExcepcion, DatoNoEncontradoException 
	{	
		Proceso encontrado= buscarProceso(idProceso);
		boolean agregado;
		...
		if(encontrado!=null)
		{
			agregado=encontrado.agregarDespuesDeUltimaActividadCreada(actividadNueva);
			return agregado;
		}
		else
		{
	 ...
	 * 
	 */
	public boolean intercambiarActividad(String idProceso,String nombreActividad,String nombreActividad2, int opcion) throws ObjetoRepetidoExcepcion, DatoNoEncontradoException
	{
		Proceso encontrado= buscarProceso(idProceso);
		...
		if(encontrado!=null)
		{
			intercambiado=encontrado.intercambiarActividad(nombreActividad, nombreActividad2, opcion);
	 ...
	 * 
	 */
	public boolean calcularTiempoMaximoYMinimo(String nombreActividad) throws DatoNoEncontradoException
	{
	...
	public boolean buscarActividadBoolean(String nombreActividad) {
		
		boolean encontrada=false;
		
		try {
			Actividad actividadEncontrada=buscarActividad(nombreActividad);
	 ...
	 * 
	 */
	public boolean crearTarea(String idProceso, String nombreActividad, Tarea tarea) throws DatoNoEncontradoException, TareaOpcionalException
	{
		Proceso encontrado= buscarProceso(idProceso);
		boolean agregado;
		...
		if(encontrado!=null)
		{
			agregado=encontrado.agregarTarea(nombreActividad, tarea);
			return agregado;
		}
		else
		{
	 ...
	 * 
	 */
	public boolean crearTareaEnUnaPosicion(String idProceso, String nombreActividad,int posicion, Tarea tarea) throws DatoNoEncontradoException, TareaOpcionalException
	{
		Proceso encontrado= buscarProceso(idProceso);
		boolean agregado;
		...
		if(encontrado!=null)
		{
			agregado=encontrado.agregarTareaEnUnaPosicion(nombreActividad, posicion, tarea);
			return agregado;
		}
		else
		{
	 ...
	 * 
	 */
	public boolean buscarTareaDesdeElInicio(String nombreTareaABuscar) throws DatoNoEncontradoException
	{
		Proceso procesoAux=listaDeProcesos.getPrimero();
	 ...
	 * 
	 */
	public boolean buscarTareaDesdeElActual(String nombreTareaABuscar) throws DatoNoEncontradoException
	{
	 ...
	 * 
	 */
	public boolean buscarTareaPorNombreDeActividad(String nombreActividad,String nombreTareaABuscar) throws DatoNoEncontradoException
	{
		Proceso procesoAux=listaDeProcesos.getPrimero();
	...
	/**
	 * Metodo que permite calcular el tiempo de realizacion de un proceso
	 * 
	 ...
	 * 
	 */
	public int calcularDuracion(String idProceso) throws DatoNoEncontradoException
	{
		Proceso encontrado= buscarProceso(idProceso);
		...
		if(encontrado!=null)
		{
			duracion += encontrado.calcularDuracion();
		}
		else
		{
			throw new DatoNoEncontradoException("El proceso no existe");

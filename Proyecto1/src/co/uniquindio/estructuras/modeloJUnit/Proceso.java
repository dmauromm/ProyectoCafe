...
public class Proceso implements Serializable
{
	 ...
	 * 									 iguales
	 */
	public boolean agregarActividadNormal(Actividad actividadNueva)
	{
	 ...
	 * 
	 */
	public boolean agregarActividadAlUltimo(Actividad actividadNueva) throws ObjetoRepetidoExcepcion
	{
		Actividad nuevaActividad = actividadNueva;
	 ...
	 * 
	 */
	public boolean agregarActividadEnPosicion(String nombre, Actividad actividadNueva) throws DatoNoEncontradoException, ObjetoRepetidoExcepcion{
	 ...
	 * 
	 */
	public boolean agregarDespuesDeUltimaActividadCreada(Actividad actividadNueva) throws ObjetoRepetidoExcepcion
	{
		if(buscarActividadBooleano(actividadNueva.getNombre())!=true)
		{
	...
	public void modificarAcitividad(String nombreActividad,String nombre, String descripcion, boolean esObligatorio) throws ObjetoRepetidoExcepcion, DatoNoEncontradoException
	{
		...
		if(encontrado!=null)
		{
			if(buscarActividadBooleano(nombre)!=true)
			{
				...
				encontrado.setColaTareas(buscarActividad(nombreActividad).getColaTareas());
			}
			else
			{
	 ...
	 * 
	 */
	public boolean intercambiarActividad(String nombreActividad,String nombreActividad2, int opcion) throws ObjetoRepetidoExcepcion, DatoNoEncontradoException
	{
		Actividad encontrado= buscarActividad(nombreActividad);
	 ...
	 * 
	 */
	public boolean agregarTarea(String nombreActividad, Tarea tarea) throws DatoNoEncontradoException, TareaOpcionalException
	{
		Actividad encontrado= buscarActividad(nombreActividad);
	 ...
	 * 
	 */
	public boolean agregarTareaEnUnaPosicion(String nombreActividad,int posicion, Tarea tarea) throws TareaOpcionalException, DatoNoEncontradoException 
	{
		Actividad encontrado= buscarActividad(nombreActividad);
	 ...
	 * 
	 */
	public int calcularDuracion() throws DatoNoEncontradoException
	{
		int duracion=0;
